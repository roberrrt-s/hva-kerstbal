...
export function snow() {
	...
	// Define the amount of snowflakes
	const numberOfSnowflakes = config.snowflakeAmount
	...
	//
	function generateSnowflakes(config) {

		// get our snowflake element from the DOM and store it
		const originalSnowflake = document.querySelector("#snow span");
